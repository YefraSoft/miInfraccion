      ...
      <div id="formContent">
        ...
        <div class="header-options">
          ...
          <div class="option cursor-pointer" @click="setActiveTab('register')">
            <h2 :class="{'active': activeTab === 'register', 'inactive': activeTab !== 'register'}">Registro Ciudadanos</h2>
          </div>
        ...
        <div v-if="activeTab === 'login'">
          <form v-on:submit.prevent="login">
            <input type="text" id="login" class="fadeIn second" name="login" placeholder="Correo electrónico" v-model="email">
        ...
        <div v-if="activeTab === 'register'">
          <form v-on:submit.prevent="register">
            <input type="text" id="register" class="fadeIn second" name="register" placeholder="Nombre" v-model="nombre">
            <input type="email" id="email" class="fadeIn third" name="email" placeholder="Email" v-model="email">
            <input type="password" id="password-register" class="fadeIn third" name="password-register" placeholder="Password" v-model="password">
        ...
        <div v-if="activeTab === 'agent'">
          <form v-on:submit.prevent="loginAgent">
            <input type="text" id="agent-number" class="fadeIn second" name="agent-number" placeholder="Número de Agente" v-model="agentNumber">
            <input type="password" id="agent-password" class="fadeIn third" name="agent-password" placeholder="Contraseña" v-model="agentPassword">
...
export default {
  ...
  try {
    ...
    if (response.status === 201) {
      ...
      // Cambiar la pestaña activa al formulario de login en lugar de redirigir
    ...
    // Método para inicio de sesión de agentes
    async loginAgent() {
